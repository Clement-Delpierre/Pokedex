...
namespace Pokedex.Models
{
    internal class PokeMove
    {
        ...
        /// </summary>
        /// <returns>Return move description and information</returns>
        public override string ToString()
        {
            StringBuilder description = new StringBuilder();

            description.AppendFormat($"{this._nameFr} : power({this._power}), accuracy({this._accuracy}).");
            description.AppendLine();
            description.AppendFormat($"Type : {this._type.Name}, {this._damage}.\n{ this.DescriptionFr}");
